...
class AuthenticationServiceImpl :
    ...
    override fun updateUserInfo(email: String?,userInfoDto: UserInfoDto): UserInfoDto {
        return authenticationDao.updateUserInfo(email,userInfoDto).apply { password = null }
    }
